...
- Shared `catalog.csv` and `status.csv` were intentionally not updated because the user assigned ownership only to `data/model_archive/mmb_derivations/NK_GM07/`.
